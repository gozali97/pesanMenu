    ...
    <div class="login-header box-shadow">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <div class="login-menu">
                <ul>
                    <li><a href="/user/login" data-color="#E94560">Login</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h2 class="text-center" data-color="#E94560">Create Account RestoApp</h2>
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="input-group mb-0">
                        <!--
										...
										-->
                        <button type="submit" class="btn btn-lg btn-block text-white" data-bgcolor="#E94560" href="">Register</button>
                    </div>
